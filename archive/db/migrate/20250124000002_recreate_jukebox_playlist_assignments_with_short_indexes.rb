class RecreateJukeboxPlaylistAssignmentsWithShortIndexes < ActiveRecord::Migration[7.0]
  def change
    # Drop the table that was partially created
    drop_table :jukebox_playlist_assignments if table_exists?(:jukebox_playlist_assignments)
    
    # Recreate it with proper short index names
